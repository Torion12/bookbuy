   ...
   <div class="row">
      <div class="col-md-2">
         <ul class="nav nav-pills nav-stacked">
            ...
            <li role="presentation" class="active"><a href="dean_list.php">Deans</a></li> -->
         ...
         <div class="row">
            ...
            <div class="col-md-12">
               <div class="row">
                  ...
                  <button class="btn btn-info btn-lg pull-right btn-block open-add-user-modal" data-user-type="dean">&plus; Dean</button>
                  </div>
               </div>
...
<script>
   getUsers('dean', '#dean-list');

   $('body').on('click', '.edit-user', function() {
      openEditUserModal('dean', $(this).data('id'));
   })

   $('#edit-user').on('click', '.edit-user-save', function() {
      console.log($('#edit-user-id').val())
      updateUser('dean', $('#edit-user-id').val());
      getUsers('dean', '#dean-list');
   })

   $('body').on('click', '.delete-user', function() {
      deleteUser('dean', $(this).data('id'));
      getUsers('dean', '#dean-list');
   })
</script>